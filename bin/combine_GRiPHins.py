...
def combine_centar(ordered_centar_df_1, centar_df_lens_1, centar_df_column_names_1, ordered_centar_df_2, centar_df_lens_2, centar_df_column_names_2):
    ...
    other_Tox = [ "tcdC_Variant", "tcdC other mutations", "tcdC", "tcdR", "tcdE", "cdtA", 'cdtR_Variant', "cdtR other mutations", "cdtB", "cdtR", "cdtAB1", "cdtAB2", "PaLoc_NonTox_Variant", "PaLoc_NonTox other mutations","PaLoc_NonTox", "cdt_NonTox" ]
